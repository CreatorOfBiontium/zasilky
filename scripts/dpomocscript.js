function nnds(){
    alert("Tato funkce není momentálně dostupná, ale pracuje se na ní")
}
...
function show_content_st(){
    document.getElementById("stEll").innerHTML = 'Funkce není dostupná';
    sleep(3500).then(() => {
        setTimeout(change_a(), 1);
    });
